...
export const Hero: React.FC = () => {
  return (
    <section className="h-full flex flex-col justify-center items-center md:items-start text-center md:text-left max-w-6xl lg:max-w-7xl mx-auto w-full">
      ...
      <div className="animate-enter delay-100 mb-6 lg:mb-10">
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-brand font-black text-slate-900 tracking-tighter leading-none">
          fyo
        </h1>
        <h2 className="text-3xl md:text-5xl lg:text-7xl font-brand font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 tracking-tight mt-2 lg:mt-4">
      ...
      <div className="animate-enter delay-200 flex flex-col md:flex-row gap-6 items-start mt-4 border-l-4 lg:border-l-8 border-purple-600 pl-6 lg:pl-10 ml-2 md:ml-0">
         <p className="text-lg md:text-xl lg:text-3xl text-slate-600 font-medium max-w-lg lg:max-w-2xl leading-relaxed">
           Una guía para entender cómo captamos, elegimos e integramos a los mejores talentos.
         </p>
      </div>
      
      {/* Subtle details bottom - Staggered */}
      <div className="animate-enter delay-300 mt-12 lg:mt-20 flex flex-wrap gap-3 lg:gap-5 justify-center md:justify-start">
