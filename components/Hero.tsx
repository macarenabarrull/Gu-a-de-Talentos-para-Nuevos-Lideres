...
export const Hero: React.FC<HeroProps> = ({ onStart }) => {
  return (
    <section className="min-h-full flex flex-col justify-center max-w-7xl mx-auto w-full px-8 relative z-10 py-10">
      ...
      <div className="max-w-4xl z-20">
        ...
        <div className="animate-enter delay-100 mb-10">
            <div className="flex items-baseline leading-none mb-2">
                ...
                <span className="text-[5rem] sm:text-[6rem] md:text-[8rem] lg:text-[10rem] xl:text-[11rem] font-brand font-black text-slate-900 tracking-tighter">
                    fyo
                </span>
                <span className="w-4 h-4 md:w-8 md:h-8 rounded-full bg-purple-600 mb-6 md:mb-8 ml-1"></span>
                <span className="w-4 h-4 md:w-8 md:h-8 rounded-full bg-pink-500 mb-12 md:mb-16 ml-[-8px] md:ml-[-10px] mix-blend-multiply opacity-80"></span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] xl:text-[6rem] font-brand font-black text-slate-800 tracking-[-0.03em] leading-[0.9] uppercase">
                Talento & Cultura
            </h1>
        </div>
        ...
        <div className="animate-enter delay-200 flex gap-6 items-stretch mb-12">
            ...
            <div>
                <p className="text-lg md:text-xl lg:text-2xl text-slate-600 font-medium leading-relaxed tracking-tight mb-1">
