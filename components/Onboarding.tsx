...
export const Onboarding: React.FC = () => {
  return (
    <section className="h-full flex flex-col justify-center max-w-7xl mx-auto w-full px-4">
        ...
        {/* Header Area */}
        <div className="flex flex-col lg:flex-row gap-4 lg:items-end mb-6 shrink-0">
          ...
          <div className="lg:w-1/3 pb-2">
             <div className="p-3 bg-white/80 backdrop-blur-md rounded-xl border border-purple-100 flex gap-3 items-center shadow-sm">
        ...
        <div className="flex-1 min-h-0 flex flex-col gap-6 pb-2">
            ...
            {ONBOARDING_TIPS.map((tip, i) => {
                ...
                return (
                <div key={i} className="group relative p-5 rounded-[1.25rem] bg-white border border-slate-100 hover:border-purple-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col justify-start gap-3 overflow-hidden min-h-[160px]">
                    
                    <div className="absolute top-3 right-3 text-[2rem] opacity-20 transform rotate-12 group-hover:opacity-100 group-hover:rotate-0 transition-all duration-500 pointer-events-none">
                        {emoji}
                    </div>

                    <div className="flex flex-col gap-2 relative z-10">
                        <div className="flex items-center gap-2">
                            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-50 text-slate-400 font-bold text-xs group-hover:bg-purple-600 group-hover:text-white transition-all shadow-inner">
                                {i + 1}
                            </span>
                        ...
                        <p className="text-slate-600 text-xs leading-relaxed font-medium pl-10">
                            {tip.description}
                        </p>
                    </div>
                    ...
                    {tip.leaderTip && (
                        <div className="relative z-10 mt-auto bg-purple-50 p-2.5 rounded-lg border border-purple-100 flex items-start gap-2">
            ...
            <div className="shrink-0 bg-gradient-to-r from-purple-700 to-pink-600 rounded-[1.5rem] p-6 lg:p-8 flex flex-col md:flex-row gap-6 items-center justify-between relative overflow-hidden shadow-lg group text-white">
                
                {/* Graphics */}
                <div className="absolute right-0 bottom-0 w-48 h-48 bg-white opacity-10 rounded-full blur-[40px] pointer-events-none"></div>
                <div className="absolute left-0 top-0 w-24 h-24 bg-yellow-400 opacity-20 rounded-full blur-[30px] pointer-events-none"></div>

                <div className="flex items-center gap-4 relative z-10">
                    <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white shrink-0 border border-white/20 shadow-lg">
